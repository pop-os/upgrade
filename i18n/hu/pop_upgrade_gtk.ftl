...
button-perform-refresh = Újraindítás és Helyreállítás
button-perform-upgrade = Újraindítás és Rendszerfrissítés
button-refresh = Helyreállítás
button-update = Frissítés
button-upgrade = Rendszerfrissítés
...
dialog-refresh-description =
 ...
 {"*"} Az összes felhasználó által telepített rendszeralkalmazás eltávolításra kerül
 {"*"} A /home könyvtáron kívüli rendszerpartíció összes fájlja törlődik
 {"*"} Az összes rendszerkonfigurációs módosítás elvész, kivéve:
     - A rendszer időzónája
     - A rendszer nyelve
...
new-features-include = Az új funkciók közé tartozik:

notification-dismiss-label = Értesítések
notification-dismiss-description = {-os} {$version} frissítési értesítéseinek elrejtése a következő kiadásig.

notification-title = Rendszerfrissítés elérhető
notification-description = A(z) {-os} frissítése a {$version} verzióra

most-current-recovery = A helyreállítási partíció legújabb verziója van telepítve

os-upgrade = Rendszerfrissítés
os-recovery = Rendszer-helyreállítás
os-updates = Rendszer- és alkalmazásfrissítések

permission-denied = Engedély szükséges

 Csak rendszergazdai fiókok frissíthetik az operációs rendszert.

recovery-downloading = A helyreállítási partíció frissítésének letöltése
recovery-header = Helyreállítási partíció
recovery-progress = {recovery-downloading}: ({$current} MiB a {$total} MiB-ból)
recovery-sync = Helyreállítási kép szinkronizálása a lemezre
recovery-update-found = Helyreállítási partíció frissítés elérhető
recovery-verify = A letöltött helyreállítási kép ellenőrzése

refresh-description = Újratelepítés a felhasználói fiókok és fájlok megtartásával
refresh-header = Rendszer helyreállítása
...
upgrade-preparing = Rendszerfrissítés előkészítése
upgrade-ready = A(z) {-os} készen áll a {$version} verzióra történő frissítésre
